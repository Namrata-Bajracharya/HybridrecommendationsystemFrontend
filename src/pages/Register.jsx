  ...
  return (
    <div className="max-w-md mx-auto py-20">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <input type="text" placeholder="Full name" value={name} onChange={e => setName(e.target.value)} className="w-full px-4 py-2 rounded" />
        ...
        <button type="submit" className="px-4 py-2 bg-dark text-cream rounded">Create Account</button>
      </form>
    </div>
  )
}
