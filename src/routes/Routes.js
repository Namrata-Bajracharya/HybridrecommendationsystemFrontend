...
export const routesName = {
  ...
  OrderRoute({ id, orderNumber } = {}) {
    return {
      ...
      refundAccept: id ? `${BASE_API_ROUTE}/order/${id}/refund/accept` : `${BASE_API_ROUTE}/order`,
      refundItemRetrievedFromCustomer: id ? `${BASE_API_ROUTE}/order/${id}/refund/item-retrieved-from-customer` : `${BASE_API_ROUTE}/order`,
      refundItemRetrievedByAdmin: id ? `${BASE_API_ROUTE}/order/${id}/refund/item-retrieved-by-admin` : `${BASE_API_ROUTE}/order`,
